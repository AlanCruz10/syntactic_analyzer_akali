...
_lr_productions = [
  ...
  ('PROGRAM -> BLOCK_CODE','PROGRAM',1,'p_PROGRAM','syntactic.py',95),
  ('BLOCK_CODE -> GV','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic.py',102),
  ('BLOCK_CODE -> GC','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic.py',103),
  ('BLOCK_CODE -> GF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic.py',104),
  ('BLOCK_CODE -> GCF','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic.py',105),
  ('BLOCK_CODE -> EMPTY','BLOCK_CODE',1,'p_BLOCK_CODE','syntactic.py',106),
  ('C -> GV','C',1,'p_C','syntactic.py',117),
  ('C -> GC','C',1,'p_C','syntactic.py',118),
  ('C -> GCF','C',1,'p_C','syntactic.py',119),
  ('C -> EMPTY','C',1,'p_C','syntactic.py',120),
  ('GV -> TD V I VA BLOCK_CODE','GV',5,'p_GV','syntactic.py',131),
  ('GV -> TD V BLOCK_CODE','GV',3,'p_GV','syntactic.py',132),
  ('GV -> EMPTY','GV',1,'p_GV','syntactic.py',133),
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic.py',146),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic.py',147),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic.py',148),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic.py',149),
  ('V -> VARIABLE','V',1,'p_V','syntactic.py',157),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic.py',165),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic.py',173),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic.py',174),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic.py',175),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic.py',176),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic.py',177),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic.py',188),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic.py',189),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic.py',190),
  ('CN -> IF','CN',1,'p_CN','syntactic.py',203),
  ('CD -> V S V','CD',3,'p_CD','syntactic.py',211),
  ('CD -> V S VA','CD',3,'p_CD','syntactic.py',212),
  ('CD -> VA S V','CD',3,'p_CD','syntactic.py',213),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic.py',214),
  ('S -> EQUAL','S',1,'p_S','syntactic.py',222),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic.py',223),
  ('S -> LESS_THAN','S',1,'p_S','syntactic.py',224),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic.py',225),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic.py',226),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic.py',227),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic.py',235),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic.py',236),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic.py',237),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic.py',238),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic.py',239),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic.py',240),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic.py',241),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic.py',242),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic.py',243),
  ('PR -> V','PR',1,'p_PR','syntactic.py',262),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic.py',270),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic.py',278),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic.py',286),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic.py',294),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic.py',295),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic.py',296),
  ('F -> FOR','F',1,'p_F','syntactic.py',309),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic.py',317),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic.py',325),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic.py',333),
  ('O -> ADDITION','O',1,'p_O','syntactic.py',334),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic.py',345),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic.py',353),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic.py',361),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic.py',369),
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','syntactic.py',376),
]
