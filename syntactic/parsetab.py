...
_lr_productions = [
  ...
  ('TD -> INTEGER_TYPE','TD',1,'p_TD','syntactic.py',152),
  ('TD -> BOOLEAN_TYPE','TD',1,'p_TD','syntactic.py',153),
  ('TD -> DECIMAL_TYPE','TD',1,'p_TD','syntactic.py',154),
  ('TD -> STRING_TYPE','TD',1,'p_TD','syntactic.py',155),
  ('V -> VARIABLE','V',1,'p_V','syntactic.py',163),
  ('I -> ASSIGNMENT','I',1,'p_I','syntactic.py',171),
  ('VA -> NUMBER','VA',1,'p_VA','syntactic.py',179),
  ('VA -> NUMBER DOT NUMBER','VA',3,'p_VA','syntactic.py',180),
  ('VA -> TRUE_VALUE','VA',1,'p_VA','syntactic.py',181),
  ('VA -> FALSE_VALUE','VA',1,'p_VA','syntactic.py',182),
  ('VA -> QUOTATION_MARKS V QUOTATION_MARKS','VA',3,'p_VA','syntactic.py',183),
  ('GC -> CN PA CD PC MY C MN BLOCK_CODE','GC',8,'p_GC','syntactic.py',194),
  ('GC -> CN PA CD PC MY MN BLOCK_CODE','GC',7,'p_GC','syntactic.py',195),
  ('GC -> EMPTY','GC',1,'p_GC','syntactic.py',196),
  ('CN -> IF','CN',1,'p_CN','syntactic.py',215),
  ('CD -> V S V','CD',3,'p_CD','syntactic.py',223),
  ('CD -> V S VA','CD',3,'p_CD','syntactic.py',224),
  ('CD -> VA S V','CD',3,'p_CD','syntactic.py',225),
  ('CD -> VA S VA','CD',3,'p_CD','syntactic.py',226),
  ('S -> EQUAL','S',1,'p_S','syntactic.py',234),
  ('S -> GREATER_THAN','S',1,'p_S','syntactic.py',235),
  ('S -> LESS_THAN','S',1,'p_S','syntactic.py',236),
  ('S -> GREATER_OR_EQUAL','S',1,'p_S','syntactic.py',237),
  ('S -> LESS_OR_EQUAL','S',1,'p_S','syntactic.py',238),
  ('S -> NOT_EQUAL','S',1,'p_S','syntactic.py',239),
  ('GF -> TD V ME PR MA MY C RT MN BLOCK_CODE','GF',10,'p_GF','syntactic.py',247),
  ('GF -> V ME PR MA MY C MN BLOCK_CODE','GF',8,'p_GF','syntactic.py',248),
  ('GF -> TD V ME PR MA MY RT MN BLOCK_CODE','GF',9,'p_GF','syntactic.py',249),
  ('GF -> V ME PR MA MY MN BLOCK_CODE','GF',7,'p_GF','syntactic.py',250),
  ('GF -> TD V ME MA MY C RT MN BLOCK_CODE','GF',9,'p_GF','syntactic.py',251),
  ('GF -> V ME MA MY C MN BLOCK_CODE','GF',7,'p_GF','syntactic.py',252),
  ('GF -> TD V ME MA MY RT MN BLOCK_CODE','GF',8,'p_GF','syntactic.py',253),
  ('GF -> V ME MA MY MN BLOCK_CODE','GF',6,'p_GF','syntactic.py',254),
  ('GF -> EMPTY','GF',1,'p_GF','syntactic.py',255),
  ('PR -> V','PR',1,'p_PR','syntactic.py',307),
  ('ME -> LESS_THAN','ME',1,'p_ME','syntactic.py',315),
  ('MA -> GREATER_THAN','MA',1,'p_MA','syntactic.py',323),
  ('RT -> RETURN V','RT',2,'p_RT','syntactic.py',331),
  ('GCF -> F PA CDF PC MY C MN BLOCK_CODE','GCF',8,'p_GCF','syntactic.py',339),
  ('GCF -> F PA CDF PC MY MN BLOCK_CODE','GCF',7,'p_GCF','syntactic.py',340),
  ('GCF -> EMPTY','GCF',1,'p_GCF','syntactic.py',341),
  ('F -> FOR','F',1,'p_F','syntactic.py',360),
  ('CDF -> NUMBER SE NUMBER SE O','CDF',5,'p_CDF','syntactic.py',368),
  ('SE -> PIPE','SE',1,'p_PIPE','syntactic.py',376),
  ('O -> SUBTRACTION','O',1,'p_O','syntactic.py',384),
  ('O -> ADDITION','O',1,'p_O','syntactic.py',385),
  ('PA -> PARENTHESIS_OPEN','PA',1,'p_PA','syntactic.py',396),
  ('PC -> PARENTHESIS_CLOSE','PC',1,'p_PC','syntactic.py',404),
  ('MY -> OPEN_BODY','MY',1,'p_MY','syntactic.py',412),
  ('MN -> LESS_OR_EQUAL','MN',1,'p_MN','syntactic.py',420),
  ('EMPTY -> <empty>','EMPTY',0,'p_empty','syntactic.py',427),
]
